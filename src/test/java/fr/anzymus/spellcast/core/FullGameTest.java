...
//        1        W       W +      0            W +     P        0
        ...
        decisions.cast(white, ShieldSpell.class).to(whiteWizard);
        game.endTurn();
...
//        2        W       P |                   W |     D
        ...
        decisions.cast(black, ShieldSpell.class).to(blackWizard);
        game.endTurn();
        assertEquals(14, blackWizard.getHealth());
        assertEquals(14, whiteWizard.getHealth());
...
//        4        D     + D x                   P x   | W        3
        ...
        decisions.cast(white, ResistHeatSpell.class).to(whiteWizard);
        decisions.cast(black, CauseHeavyWoundsSpell.class).to(whiteWizard);
...
//        5        F     | P x                   S     x S +
        ...
        decisions = game.validateTurn();
        decisions.cast(black, ShieldSpell.class).to(blackWizard);
        decisions.cast(white, CounterSpellOtherVersionSpell.class).to(blackWizard);
        game.endTurn();
        assertEquals(14, blackWizard.getHealth());
        assertEquals(11, whiteWizard.getHealth());
