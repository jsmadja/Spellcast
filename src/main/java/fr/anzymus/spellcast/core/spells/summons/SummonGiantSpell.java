...
import fr.anzymus.spellcast.core.creature.Giant;

public class SummonGiantSpell extends SummonSpell {

    public SummonGiantSpell() {
    ...
    protected Creature summonCreature(Wizard owner) {
        return new Giant(owner);
    }

    @Override
    public String description() {
        return "This spell is the same as 'summon goblin' but the giant created inflicts and is destroyed by 4 points of damage rather than 1.";
    }
